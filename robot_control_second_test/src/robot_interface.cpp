...
void RobotInterface::leftEncoderTicksCallback(const std_msgs::Int32::ConstPtr& msg)
    {
        encoder_ticks_[0] = msg->data;
        ROS_DEBUG_STREAM_THROTTLE(1, "Left encoder ticks: " << msg->data);
    }

void RobotInterface::rightEncoderTicksCallback(const std_msgs::Int32::ConstPtr& msg)
    {
